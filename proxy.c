...
int main(){
    ...
    void fils(int descSockCOM){
        ...
        *target = '\0';
        ...
        printf("recuperation port client ok\n");
        ...
        printf("envoi message goodbye ok\n");
